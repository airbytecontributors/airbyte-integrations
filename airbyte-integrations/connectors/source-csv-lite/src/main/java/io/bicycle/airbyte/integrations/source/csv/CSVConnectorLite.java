...
public class CSVConnectorLite extends BaseEventConnector {
    ...
    private File getFileObjectInProdMode(String csvUrl, JsonNode config) {
        CSVProdConnectorLite csvProdConnector = new CSVProdConnectorLite(csvUrl, config, this);
    ...
    public AutoCloseableIterator<AirbyteMessage> doRead(
        ...
        try {
            ...
            if (!StringUtils.isEmpty(mode) && mode.equals("prod")) {
                CSVProdConnectorLite csvProdConnector = new CSVProdConnectorLite(csvUrl, timestampformat, timeZone,
