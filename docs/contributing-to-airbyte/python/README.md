...
Additionally, you can follow [this tutorial](https://github.com/airbytehq/airbyte/tree/05bdb368a0e8031e5ae9f6d51cdb699c646b909a/airbyte-cdk/python/docs/tutorials/http_api_source.md) for a complete walkthrough of creating an HTTP connector using the Airbyte CDK.

### Concepts & Documentation

See the [overview docs](concepts/overview.md) for a tour through what the API offers.
